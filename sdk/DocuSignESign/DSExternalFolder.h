...
@protocol DSExternalFolder
@end

@interface DSExternalFolder : DSObject

/* The last position in the result set.  [optional]
 */
@property(nonatomic) NSString* endPosition;

@property(nonatomic) DSExternalDocServiceErrorDetails* errorDetails;
/*  [optional]
 */
@property(nonatomic) NSString* _id;
/*  [optional]
 */
@property(nonatomic) NSArray<DSExternalFile>* items;
/*  [optional]
 */

...
#ifndef DSDebugLogResponse
#define DSDebugLogResponse(response, responseObject,request, error) [[DSLogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef DSDebugLog
#define DSDebugLog(format, ...) [[DSLogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif
...
/**
 * Enabled switch, default NO - default set by DSConfiguration debug property
 */

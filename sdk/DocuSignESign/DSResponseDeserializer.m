...
NSString *const DSDeserializationErrorDomainKey = @"DSDeserializationErrorDomainKey";

NSInteger const DSTypeMismatchErrorCode = 143553;

NSInteger const DSEmptyValueOccurredErrorCode = 143509;

NSInteger const DSUnknownResponseObjectErrorCode = 143528;


@interface DSResponseDeserializer ()
...
@implementation DSResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:DSDeserializationErrorDomainKey code:DSTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DSDeserializationErrorDomainKey code:DSEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DSDeserializationErrorDomainKey code:DSUnknownResponseObjectErrorCode userInfo:userInfo];
}

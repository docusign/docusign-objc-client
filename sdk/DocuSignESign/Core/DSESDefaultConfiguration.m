...
#import "DSESBasicAuthTokenProvider.h"
#import "DSESLogger.h"

@interface DSESDefaultConfiguration ()
...
@implementation DSESDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static DSESDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"https://www.docusign.net/restapi";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
        ...
        _logger = [DSESLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [DSESBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];

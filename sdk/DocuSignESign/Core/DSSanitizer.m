...
NSString * DSPercentEscapedStringFromString(NSString *string) {
    static NSString * const kDSCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kDSCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kDSCharactersGeneralDelimitersToEncode stringByAppendingString:kDSCharactersSubDelimitersToEncode]];

...
NSString *const DSESDeserializationErrorDomainKey = @"DSESDeserializationErrorDomainKey";

NSInteger const DSESTypeMismatchErrorCode = 143553;

NSInteger const DSESEmptyValueOccurredErrorCode = 143509;

NSInteger const DSESUnknownResponseObjectErrorCode = 143528;


@interface DSESResponseDeserializer ()
...
@implementation DSESResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:DSESDeserializationErrorDomainKey code:DSESTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DSESDeserializationErrorDomainKey code:DSESEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DSESDeserializationErrorDomainKey code:DSESUnknownResponseObjectErrorCode userInfo:userInfo];
}

...
@protocol DSNotaryHost
@end

@interface DSNotaryHost : DSObject
...
/*  [optional]
 */
@property(nonatomic) NSString* hostRecipientId;
...
@property(nonatomic) DSPropertyMetadata* notaryEmailMetadata;

@property(nonatomic) DSPropertyMetadata* notaryNameMetadata;

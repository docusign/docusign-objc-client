...
@interface DSESWorkspacesApi_GetWorkspaceFileOptions : DSESObject
    /*
...
@interface DSESWorkspacesApi_ListWorkspaceFilePagesOptions : DSESObject
    /*
...
@interface DSESWorkspacesApi_ListWorkspaceFolderItemsOptions : DSESObject 
    /*
    * count The maximum number of results to be returned by this request.
    */
    @property NSString* count;
...
@interface DSESWorkspacesApi: NSObject <DSESApi>

extern NSString* kDSESWorkspacesApiErrorDomain;
extern NSInteger kDSESWorkspacesApiMissingParamErrorCode;
...
///  code:400 message:"Error encountered."
///
/// @return DSESWorkspaceFolderContents*

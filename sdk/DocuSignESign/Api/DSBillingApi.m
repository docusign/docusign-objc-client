...
///  code:200 message:"Successful response.",
///  code:400 message:"Error encountered."
/// @return DSCreditCardInformation*
-(NSNumber*) getCreditCardInfoWithAccountId:
(NSString*) accountId 
 ...
 completionHandler: (void (^)(DSCreditCardInformation* output, NSError* error)) handler {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/accounts/{accountId}/billing_plan/credit_card"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"DSCreditCardInformation*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((DSCreditCardInformation*)data, error);
                                }
                           }
          ];
}

...
@end
@implementation DSTemplatesApi_GetDocumentTabsOptions
@end
@implementation DSTemplatesApi_GetPagesOptions
@end
...
/// @param DSTemplatesApi_GetDocumentTabsOptions Options for modifying the behavior of the function.
///  code:200 message:"Successful response.",
///  code:400 message:"Error encountered."
/// @return DSTabs*
-(NSNumber*) getDocumentTabsWithAccountId:
(NSString*) accountId  templateId:(NSString*) templateId  documentId:(NSString*) documentId 

 options:(DSTemplatesApi_GetDocumentTabsOptions*) options
 completionHandler: (void (^)(DSTabs* output, NSError* error)) handler {
    // verify the required parameter 'accountId' is set
    if (accountId == nil) {
        NSParameterAssert(accountId);
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/accounts/{accountId}/templates/{templateId}/documents/{documentId}/tabs"];
...
///  code:400 message:"Error encountered."
/// @return DSTabs*
-(NSNumber*) getPageTabsWithAccountId:
(NSString*) accountId  templateId:(NSString*) templateId  documentId:(NSString*) documentId  pageNumber:(NSString*) pageNumber 
 ...
 completionHandler: (void (^)(DSTabs* output, NSError* error)) handler {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/accounts/{accountId}/templates/{templateId}/documents/{documentId}/pages/{pageNumber}/tabs"];
...
/// @param DSTemplatesApi_GetPagesOptions Options for modifying the behavior of the function.
///  code:200 message:"Successful response.",
///  code:400 message:"Error encountered."
/// @return DSPageImages*
-(NSNumber*) getPagesWithAccountId:
(NSString*) accountId  templateId:(NSString*) templateId  documentId:(NSString*) documentId 

 options:(DSTemplatesApi_GetPagesOptions*) options
 completionHandler: (void (^)(DSPageImages* output, NSError* error)) handler {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/accounts/{accountId}/templates/{templateId}/documents/{documentId}/pages"];

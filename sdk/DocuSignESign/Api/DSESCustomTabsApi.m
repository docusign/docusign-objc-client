...
@implementation DSESCustomTabsApi_ListOptions
@end



@interface DSESCustomTabsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation DSESCustomTabsApi

NSString* kDSESCustomTabsApiErrorDomain = @"DSESCustomTabsApiErrorDomain";
NSInteger kDSESCustomTabsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createWithAccountId:
    ...
    if (accountId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kDSESCustomTabsApiErrorDomain code:kDSESCustomTabsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2.1/accounts/{accountId}/tab_definitions"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"DSESTabMetadata*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((DSESTabMetadata*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) deleteWithAccountId:
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2.1/accounts/{accountId}/tab_definitions/{customTabId}"];
...
-(NSURLSessionTask*) listWithAccountId:
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"DSESTabMetadataList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((DSESTabMetadataList*)data, error);
                                }
                            }];
}

...
@end
@implementation DSEnvelopesApi_GetDocumentTabsOptions
@end
@implementation DSEnvelopesApi_GetEnvelopeOptions
@end
@implementation DSEnvelopesApi_GetPagesOptions
@end
...
/// @param DSEnvelopesApi_GetDocumentTabsOptions Options for modifying the behavior of the function.
///  code:200 message:"Successful response.",
///  code:400 message:"Error encountered."
/// @return DSTabs*
...
(NSString*) accountId  envelopeId:(NSString*) envelopeId  documentId:(NSString*) documentId 
 ...
 options:(DSEnvelopesApi_GetDocumentTabsOptions*) options
 completionHandler: (void (^)(DSTabs* output, NSError* error)) handler {
    // verify the required parameter 'accountId' is set
    if (accountId == nil) {
        NSParameterAssert(accountId);
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/accounts/{accountId}/envelopes/{envelopeId}/documents/{documentId}/tabs"];
...
(NSString*) accountId  envelopeId:(NSString*) envelopeId  documentId:(NSString*) documentId  pageNumber:(NSString*) pageNumber 
 ...
 completionHandler: (void (^)(DSTabs* output, NSError* error)) handler {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/accounts/{accountId}/envelopes/{envelopeId}/documents/{documentId}/pages/{pageNumber}/tabs"];
...
/// @param DSEnvelopesApi_GetPagesOptions Options for modifying the behavior of the function.
///  code:200 message:"Successful response.",
///  code:400 message:"Error encountered."
/// @return DSPageImages*
...
(NSString*) accountId  envelopeId:(NSString*) envelopeId  documentId:(NSString*) documentId 
 ...
 options:(DSEnvelopesApi_GetPagesOptions*) options
 completionHandler: (void (^)(DSPageImages* output, NSError* error)) handler {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/accounts/{accountId}/envelopes/{envelopeId}/documents/{documentId}/pages"];

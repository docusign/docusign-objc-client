...
@interface DSESFoldersApi_ListItemsOptions : DSESObject 
    /*
...
@interface DSESFoldersApi: NSObject <DSESApi>

extern NSString* kDSESFoldersApiErrorDomain;
extern NSInteger kDSESFoldersApiMissingParamErrorCode;

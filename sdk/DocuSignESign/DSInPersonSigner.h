...
@protocol DSInPersonSigner
@end

@interface DSInPersonSigner : DSObject
...
@property(nonatomic) DSNotaryHost* notaryHost;
...
@property(nonatomic) DSOfflineAttributes* offlineAttributes;
...
/*  [optional]
 */
@property(nonatomic) NSArray<DSRecipientSignatureProvider>* recipientSignatureProviders;
/*  [optional]
 */
...
@property(nonatomic) DSRecipientSignatureInformation* signatureInfo;
/* Reserved: For DocuSign use only.  [optional]
 */

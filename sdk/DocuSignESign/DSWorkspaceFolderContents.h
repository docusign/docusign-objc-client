...
@protocol DSWorkspaceFolderContents
@end

@interface DSWorkspaceFolderContents : DSObject

/* The last position in the result set.  [optional]
 */
@property(nonatomic) NSString* endPosition;

@property(nonatomic) DSWorkspaceItem* folder;
/*  [optional]
 */
@property(nonatomic) NSArray<DSWorkspaceItem>* items;
/*  [optional]
 */
@property(nonatomic) NSArray<DSWorkspaceItem>* parentFolders;

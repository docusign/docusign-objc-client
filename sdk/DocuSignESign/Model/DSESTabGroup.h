...
@interface DSESTabGroup : DSESObject
...
@property(nonatomic) DSESPropertyMetadata* groupLabelMetadata;
/*  [optional]
 */
@property(nonatomic) NSString* groupRule;

@property(nonatomic) DSESPropertyMetadata* groupRuleMetadata;
...
/*  [optional]
 */
@property(nonatomic) NSString* maximumAllowed;

@property(nonatomic) DSESPropertyMetadata* maximumAllowedMetadata;
...
/*  [optional]
 */
@property(nonatomic) NSString* minimumRequired;

@property(nonatomic) DSESPropertyMetadata* minimumRequiredMetadata;
...
/*  [optional]
 */
@property(nonatomic) NSString* tabScope;

@property(nonatomic) DSESPropertyMetadata* tabScopeMetadata;
/*  [optional]
 */

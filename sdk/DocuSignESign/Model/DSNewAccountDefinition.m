...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"accountName", @"accountSettings", @"addressInformation", @"creditCardInformation", @"distributorCode", @"distributorPassword", @"initialUser", @"paymentProcessorInformation", @"planInformation", @"referralInformation", @"socialAccountInformation"];

...
@protocol DSESPowerFormsResponse
@end

@interface DSESPowerFormsResponse : DSESObject
 ...
 */
@property(nonatomic) NSNumber* resultSetSize;
 ...
 */
@property(nonatomic) NSNumber* totalSetSize;

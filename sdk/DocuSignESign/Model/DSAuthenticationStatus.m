...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"accessCodeResult", @"ageVerifyResult", @"anySocialIDResult", @"facebookResult", @"googleResult", @"idLookupResult", @"idQuestionsResult", @"linkedinResult", @"liveIDResult", @"ofacResult", @"openIDResult", @"phoneAuthResult", @"salesforceResult", @"signatureProviderResult", @"smsAuthResult", @"sTANPinResult", @"twitterResult", @"yahooResult"];

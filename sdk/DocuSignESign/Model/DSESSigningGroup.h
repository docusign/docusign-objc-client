...
@protocol DSESSigningGroupUser;
@class DSESSigningGroupUser;



@protocol DSESSigningGroup
@end

@interface DSESSigningGroup : DSESObject
...
/*  [optional]
 */
@property(nonatomic) NSArray<DSESSigningGroupUser>* users;

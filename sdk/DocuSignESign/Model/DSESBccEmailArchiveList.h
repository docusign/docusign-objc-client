...
@class DSESBccEmailArchive;



@protocol DSESBccEmailArchiveList
@end

@interface DSESBccEmailArchiveList : DSESObject

/*  [optional]
 */
@property(nonatomic) NSArray<DSESBccEmailArchive>* bccEmailArchives;

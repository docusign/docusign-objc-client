...
/* The list of values that can be selected by senders. The list values are separated by semi-colons. Example: [one;two;three;four]  Maximum Length of listItems:  2048 characters. Maximum Length of items in the list: 100 characters.   [optional]
 */
@property(nonatomic) NSArray<DSESListItem>* listItems;
/*  [optional]
 */
@property(nonatomic) NSString* listSelectedValue;

@property(nonatomic) DSESPropertyMetadata* listSelectedValueMetadata;

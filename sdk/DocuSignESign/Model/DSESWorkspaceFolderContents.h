...
@class DSESWorkspaceItem;



@protocol DSESWorkspaceFolderContents
@end

@interface DSESWorkspaceFolderContents : DSESObject

/* The last position in the result set.  [optional]
 */
@property(nonatomic) NSString* endPosition;

@property(nonatomic) DSESWorkspaceItem* folder;
/*  [optional]
 */
@property(nonatomic) NSArray<DSESWorkspaceItem>* items;
/*  [optional]
 */
@property(nonatomic) NSArray<DSESWorkspaceItem>* parentFolders;

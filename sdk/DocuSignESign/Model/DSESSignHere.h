...
@interface DSESSignHere : DSESObject
...
/*  [optional]
 */
@property(nonatomic) NSString* isSealSignTab;
...
@property(nonatomic) DSESPropertyMetadata* optionalMetadata;
...
@property(nonatomic) DSESPropertyMetadata* scaleValueMetadata;

@property(nonatomic) DSESSmartContractInformation* smartContractInformation;

@property(nonatomic) DSESStamp* stamp;
/*  [optional]
 */

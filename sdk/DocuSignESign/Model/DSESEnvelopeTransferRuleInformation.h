...
@class DSESEnvelopeTransferRule;



@protocol DSESEnvelopeTransferRuleInformation
@end

@interface DSESEnvelopeTransferRuleInformation : DSESObject
...
/*  [optional]
 */
@property(nonatomic) NSArray<DSESEnvelopeTransferRule>* envelopeTransferRules;

#import <DSESLoginAccount.h>

@implementation DSESLoginAccount
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"accountId": @"accountId", @"accountIdGuid": @"accountIdGuid", @"baseUrl": @"baseUrl", @"email": @"email", @"isDefault": @"isDefault", @"loginAccountSettings": @"loginAccountSettings", @"loginUserSettings": @"loginUserSettings", @"name": @"name", @"siteDescription": @"siteDescription", @"userId": @"userId", @"userName": @"userName" }];
}

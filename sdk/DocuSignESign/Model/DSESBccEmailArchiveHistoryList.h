...
@class DSESBccEmailArchiveHistory;



@protocol DSESBccEmailArchiveHistoryList
@end

@interface DSESBccEmailArchiveHistoryList : DSESObject

/*  [optional]
 */
@property(nonatomic) NSArray<DSESBccEmailArchiveHistory>* bccEmailArchiveHistory;

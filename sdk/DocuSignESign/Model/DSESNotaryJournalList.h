...
@class DSESNotaryJournal;



@protocol DSESNotaryJournalList
@end

@interface DSESNotaryJournalList : DSESObject
...
/*  [optional]
 */
@property(nonatomic) NSArray<DSESNotaryJournal>* notaryJournals;

...
@property(nonatomic) DSESPropertyMetadata* formulaMetadata;
...
@property(nonatomic) DSESPropertyMetadata* hiddenMetadata;
...
@property(nonatomic) DSESPropertyMetadata* isPaymentAmountMetadata;
...
@property(nonatomic) DSESPaymentDetails* paymentDetails;
...
@property(nonatomic) DSESPropertyMetadata* roundDecimalPlacesMetadata;

...
@implementation DSESUserSignature
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"adoptedDateTime", @"createdDateTime", @"customField", @"dateStampProperties", @"disallowUserResizeStamp", @"errorDetails", @"externalID", @"imageBase64", @"imageType", @"initials150ImageId", @"initialsImageUri", @"isDefault", @"lastModifiedDateTime", @"nrdsId", @"nrdsLastName", @"nrdsStatus", @"phoneticName", @"signature150ImageId", @"signatureFont", @"signatureId", @"signatureImageUri", @"signatureInitials", @"signatureName", @"signatureRights", @"signatureType", @"stampFormat", @"stampImageUri", @"stampSizeMM", @"stampType", @"status"];

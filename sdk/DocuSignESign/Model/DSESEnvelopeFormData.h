...
@class DSESRecipientFormData;



@protocol DSESEnvelopeFormData
@end

@interface DSESEnvelopeFormData : DSESObject
...
/*  [optional]
 */
@property(nonatomic) NSArray<DSESRecipientFormData>* recipientFormData;

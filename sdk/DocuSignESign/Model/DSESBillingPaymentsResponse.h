...
@protocol DSESBillingPaymentItem;
@class DSESBillingPaymentItem;



@protocol DSESBillingPaymentsResponse
@end

@interface DSESBillingPaymentsResponse : DSESObject

/* Reserved: TBD [optional]
 */
@property(nonatomic) NSArray<DSESBillingPaymentItem>* billingPayments;

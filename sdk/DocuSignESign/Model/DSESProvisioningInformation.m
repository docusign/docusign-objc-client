...
@implementation DSESProvisioningInformation
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"defaultConnectionId": @"defaultConnectionId", @"defaultPlanId": @"defaultPlanId", @"distributorCode": @"distributorCode", @"distributorPassword": @"distributorPassword", @"passwordRuleText": @"passwordRuleText", @"planPromotionText": @"planPromotionText", @"purchaseOrderOrPromAllowed": @"purchaseOrderOrPromAllowed" }];
}

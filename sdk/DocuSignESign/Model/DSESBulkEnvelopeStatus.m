...
@implementation DSESBulkEnvelopeStatus
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"batchId": @"batchId", @"batchSize": @"batchSize", @"bulkEnvelopes": @"bulkEnvelopes", @"bulkEnvelopesBatchUri": @"bulkEnvelopesBatchUri", @"endPosition": @"endPosition", @"failed": @"failed", @"nextUri": @"nextUri", @"previousUri": @"previousUri", @"queued": @"queued", @"resultSetSize": @"resultSetSize", @"sent": @"sent", @"startPosition": @"startPosition", @"submittedDate": @"submittedDate", @"totalSetSize": @"totalSetSize" }];
}

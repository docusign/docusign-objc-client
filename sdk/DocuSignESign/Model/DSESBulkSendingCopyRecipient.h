...
@protocol DSESBulkSendingCopyTab;
@class DSESBulkSendingCopyTab;
...
@interface DSESBulkSendingCopyRecipient : DSESObject
...
/*  [optional]
 */
@property(nonatomic) NSString* identificationMethod;
/*  [optional]
 */
...
/*  [optional]
 */
@property(nonatomic) NSArray<DSESBulkSendingCopyTab>* tabs;

...
@protocol DSESSmartSectionAnchorPosition;
@class DSESSmartSectionAnchorPosition;
@protocol DSESSmartSectionDisplaySettings;
@class DSESSmartSectionDisplaySettings;
...
@interface DSESSmartSection : DSESObject
...
@property(nonatomic) DSESSmartSectionDisplaySettings* displaySettings;
...
@property(nonatomic) DSESSmartSectionAnchorPosition* endPosition;
...
@property(nonatomic) DSESSmartSectionAnchorPosition* startPosition;

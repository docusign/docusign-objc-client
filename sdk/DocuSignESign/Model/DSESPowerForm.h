...
@protocol DSESPowerFormRecipient;
@class DSESPowerFormRecipient;
...
@interface DSESPowerForm : DSESObject
 ...
 */
@property(nonatomic) NSArray<DSESPowerFormRecipient>* recipients;
/*  [optional]
 */

...
@protocol DSESBulkEnvelopesResponse
@end

@interface DSESBulkEnvelopesResponse : DSESObject

/* Reserved: TBD [optional]
 */
@property(nonatomic) NSArray<DSESBulkEnvelopeStatus>* bulkEnvelopeStatuses;

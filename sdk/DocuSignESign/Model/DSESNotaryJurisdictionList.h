...
@class DSESNotaryJurisdiction;



@protocol DSESNotaryJurisdictionList
@end

@interface DSESNotaryJurisdictionList : DSESObject
...
/*  [optional]
 */
@property(nonatomic) NSArray<DSESNotaryJurisdiction>* notaryJurisdictions;

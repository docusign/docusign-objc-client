...
@property(nonatomic) DSESPropertyMetadata* recipMayProvideNumberMetadata;
/* Reserved. [optional]
 */
@property(nonatomic) NSString* recordVoicePrint;

@property(nonatomic) DSESPropertyMetadata* recordVoicePrintMetadata;
...
@property(nonatomic) DSESPropertyMetadata* senderProvidedNumbersMetadata;
/*  Reserved. [optional]
 */
@property(nonatomic) NSString* validateRecipProvidedNumber;

@property(nonatomic) DSESPropertyMetadata* validateRecipProvidedNumberMetadata;

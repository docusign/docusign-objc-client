...
@protocol DSESExternalDocServiceErrorDetails;
@class DSESExternalDocServiceErrorDetails;
@protocol DSESExternalFile;
@class DSESExternalFile;



@protocol DSESExternalFolder
@end

@interface DSESExternalFolder : DSESObject

/* The last position in the result set.  [optional]
 */
@property(nonatomic) NSString* endPosition;

@property(nonatomic) DSESExternalDocServiceErrorDetails* errorDetails;
/*  [optional]
 */
@property(nonatomic) NSString* _id;
/*  [optional]
 */
@property(nonatomic) NSArray<DSESExternalFile>* items;
/*  [optional]
 */

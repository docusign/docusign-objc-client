...
@protocol DSEnvelopesInformation
@end

@interface DSEnvelopesInformation : DSObject
...
/*  [optional]
 */
@property(nonatomic) NSArray<DSEnvelopeTransactionStatus>* envelopeTransactionStatuses;

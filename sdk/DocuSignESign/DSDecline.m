...
{
  NSArray *optionalProperties = @[@"buttonText", @"width", @"height", @"declineReason", @"tabLabel", @"font", @"bold", @"italic", @"underline", @"fontColor", @"fontSize", @"documentId", @"recipientId", @"pageNumber", @"xPosition", @"yPosition", @"anchorString", @"anchorXOffset", @"anchorYOffset", @"anchorUnits", @"anchorIgnoreIfNotPresent", @"anchorCaseSensitive", @"anchorMatchWholeWord", @"anchorHorizontalAlignment", @"tabId", @"templateLocked", @"templateRequired", @"conditionalParentLabel", @"conditionalParentValue", @"customTabId", @"mergeField", @"status", @"errorDetails"];

...
**buttonText** | **NSString*** |  Specifies the decline text displayed in the tab. | [optional] 
...
**declineReason** | **NSString*** | The reason the recipient declined the document. | [optional] 

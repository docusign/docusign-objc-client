...
{
  NSArray *optionalProperties = @[@"hostName", @"hostEmail", @"signerName", @"signerEmail", @"signatureInfo", @"defaultRecipient", @"offlineAttributes", @"tabs", @"signInEachLocation", @"requireSignerCertificate", @"requireSignOnPaper", @"canSignOffline", @"recipientSuppliesTabs", @"signingGroupId", @"signingGroupName", @"signingGroupUsers", @"recipientId", @"recipientIdGuid", @"accessCode", @"addAccessCodeToEmail", @"requireIdLookup", @"idCheckConfigurationName", @"socialAuthentications", @"phoneAuthentication", @"samlAuthentication", @"smsAuthentication", @"userId", @"clientUserId", @"embeddedRecipientStartURL", @"customFields", @"routingOrder", @"idCheckInformationInput", @"recipientAttachments", @"note", @"roleName", @"status", @"signedDateTime", @"deliveredDateTime", @"declinedDateTime", @"sentDateTime", @"declinedReason", @"deliveryMethod", @"faxNumber", @"templateLocked", @"templateRequired", @"emailNotification", @"inheritEmailNotificationConfiguration", @"errorDetails", @"recipientAuthenticationStatus", @"totalTabCount"];
